...
{
    [ApiController] // We have to add this attribute to our controllers
    [Route("api/[controller]")] // We also have to specify the route. If the client wishes to use this controller, it will need to specify 'api/Users'
